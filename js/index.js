...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://github.com/tuan-anh-https://github.com/anhtuanqwe', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Facebook');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/profile.php?id=61566241707057', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.tiktok.com/@anhtuanqwe', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
...
welcomeText.textContent = " Web lỏ màu mè ";
